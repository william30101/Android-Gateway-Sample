...
//	  cause.printStackTrace();
  ...
  public void messageArrived(String topic, MqttMessage message) throws Exception {
    ...
    Log.i(TAG, "receive MQTT message : " + messageString);

    //Get string , and store to JSON
    JSONObject jsonObj = new JSONObject(new String(message.getPayload()));
    Log.i(TAG, "JSON string : " + jsonObj.toString());

    String cmdTarget = jsonObj.optString("targets");
    Log.i(TAG,"target is  : " + cmdTarget);
